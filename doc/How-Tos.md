...
- [get/set the properties](#get-or-set-the-properties)
    ...
    - [get layer types](#access-layer-properties)
    - [get weight vector](#get-weight-vector)
    - [set the weight initialization](#set-the-weight-initialization)
    - [set the seed value](#set-the-seed-value)
- [tune the performance](#control-performance)
    - [profile](#profile)
    - [change the number of threads while training](#change-the-number-of-threads-while-training)
    - [reduce memory consumptions](#reduce-memory-consumptions)
...
### <a name="handle-error"></a>change the seed value
...
### <a name="handle-error"></a>handle errors
