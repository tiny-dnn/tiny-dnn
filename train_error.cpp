...
#undef X
  ...
  nn << convolutional_error_layer<tan_h>(32, 32, 5, 1,
     ...
     << convolutional_error_layer<tan_h>(5, 5, 5, 16,
                                   120,  // C5, 16@5x5-in, 120@1x1-out
                                   padding::valid, true, 1, 1, backend_type)
     << fully_connected_error_layer<tan_h>(120, 10,  // F6, 120-in, 10-out
                                     true, backend_type);
}
